...
public class BaseDaoHibImpl <POJO> extends HibernateDaoSupport 
	...
	public Long save(POJO pojo) {
		...
		try {
			...
			return (Long)getHibernateTemplate().save(pojo);
