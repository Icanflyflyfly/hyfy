...
com.bhtec.view.Login = function(config) {
	var topPanel = {
		...
		height : 160,
		html:'',
		bodyStyle : "background:url(img/hyfy.png) no-repeat center ;background-size: 50%;"
	}
	/**
	 * 用户名密码验证
	 */
	...
	var openMainpageWindow = function(usrCodeCookie){
		...
		// opener=null;
		// self.close();
		document.location.href = 'loginActionForword!loginActionForword.action?'+usrCodeCookie;
	}
	...
	var bottomPanel = {
		...
		border : false,
		autoWidth:true,
		bodyStyle : "padding-left:100px;padding-top:30px;background-color: #FFF;",
		layout : "column",
		buttonAlign : "center",
	items : [{	columnWidth : 1,
				layout : 'form',
