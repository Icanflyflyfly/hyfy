 ...
 * @date 2017-07-015
 */
Ext.namespace('com.bhtec.view.business.seal.sealsupermodify');
com.bhtec.view.business.seal.sealsupermodify.SealapplyList = function(config){
	var approvalNo_q = 'approvalNo_super_q';
	var unit_q = 'unit_super_q';
	var gridId = 'sealSuperModifyGridId';
	...
	var operateFunction = function(optFunLink){
		return function(){
			...
			if('unit_modify' == optFunLink){
				moduleForm.modifyForm();
			}else if('seal_modify' == optFunLink){
