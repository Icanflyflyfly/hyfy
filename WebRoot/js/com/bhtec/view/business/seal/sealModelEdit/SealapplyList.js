 ...
 * @date 2017-07-015
 */
Ext.namespace('com.bhtec.view.business.seal.sealModelEdit');
com.bhtec.view.business.seal.sealModelEdit.SealapplyList = function(config){
	var approvalNo_q = 'approvalNo_model_q';
	var unit_q = 'unit_model_q';
	var gridId = 'sealModelEditGridId';
	...
	var operateFunction = function(optFunLink){
		return function(){
			...
			if('model_edite' == optFunLink){
				if (ChipObj.ExecTypeSetTemplateV2(0, "S01-TY4030-001-0001", "S01-Y32-001-0001编辑模板", "", ""))
					alert("编辑完毕");
				else
					alert("编辑失败!");
			}
