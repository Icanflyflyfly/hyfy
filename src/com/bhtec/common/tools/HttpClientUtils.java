...
public class HttpClientUtils {
	...
	public static void main(String[] args) {
		...
		try {
			...
			uploadParams.put("imageFileDir", "hyfyupload");
			uploadParams.put("imageFileName", "testaa.png");
			HttpClientUtils.getInstance().uploadFileImpl(
					"http://192.168.31.90:8080/hyfy/sealAction!upload.action", "/Users/jacobllpjacobllp/Documents/mydoc/hyfypro/hyfy/src/com/bhtec/common/tools/logo.png",
					"accessoryFile", uploadParams);
		} catch (Exception e) {
			e.printStackTrace();
		}
