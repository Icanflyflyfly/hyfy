 ...
 * @author lianglp
 * @version 1.0
 * @class com.bhtec.view.business.seal.sealpublish.SealpublishVOp
 * @date 2017-12-01
 */
Ext.namespace('com.bhtec.view.business.seal.sealpublish');
com.bhtec.view.business.seal.sealpublish.SealpublishVOp = function(config){
	var moduleVOp = this;   //父类调用
	var moduleGridId = 'sealpublishGridId';//form表单id
...
Ext.extend(com.bhtec.view.business.seal.sealpublish.SealpublishVOp, com.bhtec.view.util.CommonWidgets, {});