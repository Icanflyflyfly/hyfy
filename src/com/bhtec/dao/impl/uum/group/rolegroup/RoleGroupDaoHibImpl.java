 ...
 *功能说明：
 * @author jacobliang
 * @time @Jul 26, 2017 @5:03:17 PM
 */
package com.bhtec.dao.impl.uum.group.rolegroup;
...
public class RoleGroupDaoHibImpl extends BaseDaoHibImpl implements RoleGroupDao {
	...
	public Map findRoleGroupByCon(int start,int limit,String groupName){
		String queryString = "from UumGroup ug where ug.groupType = '"+ROLE_GROUP+"'";
